...
#include "../Lib/inc/macros.h"
#include "../Lib/inc/graphic.h"
#include "../Lib/inc/sys.h"
#include "../Lib/inc/input.h"
#include "../Lib/inc/file.h"
#include "../Lib/inc/types.h"
#include "../Lib/inc/3DDisplay.h"
#include "../Lib/inc/mathFP.h"
#include "../Lib/inc/resman.h"
PROFILER_INC
...
WinMain2(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR p_cmdLine, int p_ShowCmd)
{
  ...
  int rotY=0;int posY=-10;int posZ=100;
  MSG msg;
  int i= 100;
  int incX= 1, incY= 1;
  int posCX=0;
...
//  RM_Allocate(RMI_MESH_3DS, 1);
  RM_Allocate(RMI_MESH_MD2, 1);
//  RM_Allocate(RMI_VERTEX, 10000);
  RM_Allocate(RMI_VERTEX2, 100000);
  RM_Allocate(RMI_TEXCOORD2, 100000);
  RM_Allocate(RMI_TRIANGLES2, 100000);

  V3D_SetRendererStage(RST_TEXT);
//  V3D_LoadMesh3DS(CUR_MESH_3DS, CUR_VERTEX, "Data/Zero.3DS");
  V3D_LoadMeshMD2(CUR_MESH_MD2, CUR_VERTEX2, CUR_TRIANGLES2, CUR_TEXCOORD2, "Data/tris.MD2");
  VID_LoadTGATexture(CUR_TEXTURE, CUR_TPIXEL, "Data/cloud.tga");
//  V3D_MeshSetTexture(&AR_MESH_3DS[0], &AR_TEXTURE[0]);
  V3D_MeshSetTexture(&AR_MESH_MD2[0], &AR_TEXTURE[0]);
...
//  		V3D_DrawMesh3DS(&AR_MESH_3DS[0]);
		V3D_ProcessMeshMD2(&mat, &AR_MESH_MD2[0]);
  		V3D_DrawMeshMD2(&AR_MESH_MD2[0]);
